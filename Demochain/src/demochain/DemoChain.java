...
public class DemoChain {
	 ...
	 * 
	 * for (int i = 1; i < blockchain.size(); i++) { currentBlock =
	 * blockchain.get(i); previousBlock = blockchain.get(i - 1);
	 * 
	 * if (!currentBlock.hash.equals(currentBlock.calculateHash())) {
	 * System.out.println("current hash is not equal"); return false; }
	 * 
	 * if (!currentBlock.previousHash.equals(previousBlock.hash)) {
	 * System.out.println("previous hash is not equal"); return false; }
	 * 
	 * if (!currentBlock.hash.substring(0, difficulty).endsWith(hashTarget)) {
	 * System.out.println("This block is not minned !!!!"); return false; } }
	 * return true; }
	 */
	...
	public static Boolean isChainValid() {
		...
		HashMap<String, TransactionOutput> tempUTXOs = new HashMap<String, TransactionOutput>(); // a temporary  working list of unspent
	...
	public static void main(String arg[]) {
		 ...
		 * org.bouncycastle.jce.provider.BouncyCastleProvider()); // Create the
		 * new wallets walletA = new Wallet(); walletB = new Wallet(); // Test
		 ...
		 * // Create a test transaction from WalletA to walletB Transaction
		 * transaction = new Transaction(walletA.publicKey, walletB.publicKey,
		 * 5, null); transaction.generateSignature(walletA.privateKey); //
